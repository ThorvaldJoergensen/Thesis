...
seq2 = np.array([seq_origin[12]+20, seq_origin[13], seq_origin[14]])

for i in range(0, seq2.shape[0], 3):
    for j in range(0, seq2[i].shape[0]):   
        seq2[i][j] = (seq2[i][j] * math.cos(math.radians(-25))) - (seq2[i+2][j] * math.sin(math.radians(-25)))
        seq2[i+2][j] = (seq2[i][j] * math.sin(math.radians(-25))) + (seq2[i+2][j] * math.cos(math.radians(-25)))
        seq2[i+1][j] = seq2[i+1][j]
...
ax.plot3D([xs[0+0], xs[0+1]], [ys[0+0], ys[0+1]], [zs[0+0], zs[0+1]], 'steelblue', markersize=2, label='Original')
...
_, _, transform = AlignData.procrustes(np.transpose(seq[:,[0,7,9,12]]), np.transpose(seq2[:,[0,7,9,12]]), True, True)
...
_,_, transform2 = AlignData.procrustes(np.transpose(triangle_static), np.transpose(triangle_deform), True, True)
...
# For drawing the lines between points
# Right leg
ax.plot3D([xs[0+0], xs[0+1]], [ys[0+0], ys[0+1]], [zs[0+0], zs[0+1]], 'steelblue', markersize=2, label='Aligned')
ax.plot3D([xs[0+1], xs[0+2]], [ys[0+1], ys[0+2]], [zs[0+1], zs[0+2]], 'steelblue', markersize=2)
ax.plot3D([xs[0+2], xs[0+3]], [ys[0+2], ys[0+3]], [zs[0+2], zs[0+3]], 'steelblue', markersize=2)
# Left leg
ax.plot3D([xs[0+0], xs[0+4]], [ys[0+0], ys[0+4]], [zs[0+0], zs[0+4]], 'steelblue', markersize=2)
...
ys = []
zs = []
seq2 = np.array([seq_origin[3], seq_origin[4], seq_origin[5]])
...
# For drawing the lines between points
# Right leg
ax.plot3D([xs[0+0], xs[0+1]], [ys[0+0], ys[0+1]], [zs[0+0], zs[0+1]], 'red', markersize=2, label='Reference')
ax.plot3D([xs[0+1], xs[0+2]], [ys[0+1], ys[0+2]], [zs[0+1], zs[0+2]], 'red', markersize=2)
ax.plot3D([xs[0+2], xs[0+3]], [ys[0+2], ys[0+3]], [zs[0+2], zs[0+3]], 'red', markersize=2)
# Left leg
ax.plot3D([xs[0+0], xs[0+4]], [ys[0+0], ys[0+4]], [zs[0+0], zs[0+4]], 'red', markersize=2)
ax.plot3D([xs[0+4], xs[0+5]], [ys[0+4], ys[0+5]], [zs[0+4], zs[0+5]], 'red', markersize=2)
ax.plot3D([xs[0+5], xs[0+6]], [ys[0+5], ys[0+6]], [zs[0+5], zs[0+6]], 'red', markersize=2)
# Spine
ax.plot3D([xs[0+0], xs[0+7]], [ys[0+0], ys[0+7]], [zs[0+0], zs[0+7]], 'red', markersize=2)
ax.plot3D([xs[0+7], xs[0+8]], [ys[0+7], ys[0+8]], [zs[0+7], zs[0+8]], 'red', markersize=2)
# Right arm
ax.plot3D([xs[0+7], xs[0+9]], [ys[0+7], ys[0+9]], [zs[0+7], zs[0+9]], 'red', markersize=2)
ax.plot3D([xs[0+9], xs[0+10]], [ys[0+9], ys[0+10]], [zs[0+9], zs[0+10]], 'red', markersize=2)
ax.plot3D([xs[0+10], xs[0+11]], [ys[0+10], ys[0+11]], [zs[0+10], zs[0+11]], 'red', markersize=2)
# Left arm
ax.plot3D([xs[0+7], xs[0+12]], [ys[0+7], ys[0+12]], [zs[0+7], zs[0+12]], 'red', markersize=2)
ax.plot3D([xs[0+12], xs[0+13]], [ys[0+12], ys[0+13]], [zs[0+12], zs[0+13]], 'red', markersize=2)
ax.plot3D([xs[0+13], xs[0+14]], [ys[0+13], ys[0+14]], [zs[0+13], zs[0+14]], 'red', markersize=2)
# Limit coordinates for all axes
ax.set_xlim(30,-30)
ax.set_ylim(30,-30)
ax.set_zlim(-30,30)
